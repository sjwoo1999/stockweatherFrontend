...
export default function Search() {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-[#FFF5F5] flex justify-center"
    >
      <div className="w-[393px] min-h-screen bg-white p-6 shadow-md flex flex-col overflow-y-auto">
        ...
        <p className="text-sm text-text-muted mb-4 leading-relaxed">
          이번 주 ‘삼성전자’ 관련 뉴스에서 자주 언급된 키워드예요.
          <br />
        ...
        <div
          className={`bg-surface-subtle rounded-xl p-4 mb-3 shadow-sm ${borderColor}`}
        >
          <h4 className="font-semibold mb-1">
            갤럭시 S25 시리즈 생산 330만 대로 확대
          </h4>
          <p className="text-sm text-text-muted">
            삼성전자가 미국 관세 이슈에 대응해 갤럭시 S25 생산량을 80만 대
            추가해 총 330만 대로 확대할 예정입니다.
            <br />
        ...
        <div
          className={`bg-surface-subtle rounded-xl p-4 mb-6 shadow-sm ${borderColor}`}
        >
          <h4 className="font-semibold mb-1">
            HBM3E 메모리, AI 서버 수요로 주목
          </h4>
          <p className="text-sm text-text-muted">
            AI 시장 확대에 따라 삼성전자가 12단 HBM3E를 빠르게 양산하며,
            고용량 서버용 반도체 시장에서 경쟁력을 강화하고 있습니다.
            <br />
            <span className="text-xs text-[#E30547] font-medium">
